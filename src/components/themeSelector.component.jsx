...
import themeList from "../constants/themes.constant";
export function ThemeSelectorComponent(props) {
                ...
                <div
                    ...
                    <div className="grid grid-cols-1 gap-3 p-3" tabIndex="0">
                        ...
                        {themeList.map((theme, index) => {
                            ...
                            return <div key={index + 1} className={`outline-base-content overflow-hidden rounded-lg outline-2 outline-offset-2 ${theme.value == currentTheme ? "outline" : ""}`} data-set-theme={theme.value}
                                data-act-className="outline">

                                <div data-theme={theme.value} className="bg-base-100 text-base-content w-full cursor-pointer font-sans" onClick={(e) => clickHandler(theme.value, setCurrentTheme)}>
...
function clickHandler(theme, setCurrentTheme) {
    if (!theme) return;
